...
if (isset($_SESSION['logeado']) != "SI") {
   ...
   if ($rangouser == "2") {
    ...
    $consulta2 = $conn->query("SELECT * FROM `logs_login` ORDER BY `logs_login`.`id` DESC");
?>
<div class="container-fluid pt-4 px-4">
   <div class="row g-4">
      <div class="col-12">
         <div class="bg-light rounded h-100 p-4">
            <h6 class="mb-4"><i class="bi bi-plug"></i> Registro de ingresos al panel</h6>
               ...
               <table class="table">
                  ...
                  <?php while ($conf = $consulta2->fetch()) {?>
                     <tr>
                        ...
                        <td><?php echo $conf['user_login']; ?></td>
                        <td><?php echo $conf['accion']; ?></td>
                        <td><?php echo $conf['pais_login']; ?></td>
                        <td><?php echo $conf['ip_login']; ?></td>
