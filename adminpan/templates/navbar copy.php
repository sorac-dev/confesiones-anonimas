        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="reportes.php" class="nav-item nav-link"><i class="fa fa-exclamation-circle me-2"></i>Reportes</a>
                    <a href="confesiones.php" class="nav-item nav-link"><i class="fa fa-search me-2"></i>Confesiones</a>
                    <a href="#" class="nav-item nav-link"><i class="bi bi-people"></i> Equipo moderación</a>
                    <a href="#" class="nav-item nav-link"><i class="bi bi-shield-exclamation"></i> Bloquear IP</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="bi bi-gear"></i> Logs</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="logs_confesiones.php" class="dropdown-item"><i class="bi bi-pencil-square"></i> Confesiones</a>
                            <a href="logs_reportes.php" class="dropdown-item"><i class="bi bi-lock"></i> Reportes</a>
                            <a href="#" class="dropdown-item"><i class="bi bi-shield-x"></i> Sanciones</a>
                            <a href="logs_ingresos.php" class="dropdown-item"><i class="bi bi-plug"></i> Ingresos</a>
                            <a href="logs_global.php" class="dropdown-item"><i class="bi bi-clock"></i> Logs global</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="bi bi-gear"></i> Herramientas</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="#" class="dropdown-item"><i class="bi bi-life-preserver"></i> Cambiar rango</a>
                            <a href="change-pass" class="dropdown-item"><i class="bi bi-lock"></i> Cambiar contraseñas</a>
                            <a href="invitacion.php" class="dropdown-item"><i class="bi bi-person-plus"></i> Crear invitacion</a>
                            <a href="#" class="dropdown-item"><i class="bi bi-person-x"></i> Eliminar usuario</a>
                            <a href="#" class="dropdown-item"><i class="bi bi-wrench"></i> Configuración web</a>
                        </div>
                    </div>
                </div>
            </nav>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            ...
                            <a href="system/logout.php" class="dropdown-item">Desconectarse</a>
                        </div>
                    </div>
                    <!-- Fin perfil -->
